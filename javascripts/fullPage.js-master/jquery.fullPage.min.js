    ...
    c.fn.fullpage = function (d) {
        ...
        function na(a) {
            ...
            if (b.length && !B) {
                var g = b.find(".fp-slide.active"),
                    n = null,
                    n = "prev" === a ? g.prev(".fp-slide") : g.next(".fp-slide");
                if (!n.length) {
        ...
        function A(a, b, g) {
            ...
            if ("undefined" !== typeof n && (b = {
                ...
                if (b.activeSlide.length) var e = b.activeSlide.data("anchor"),
                    f = b.activeSlide.index();
        ...
        function ra() {
            if (!U) {
                var a = h.location.hash.replace("#",
                    ...
                    a = a[1];
                if (b.length) {
                    var d = "undefined" === typeof z,
                        c = "undefined" === typeof z && "undefined" === typeof a && !B;
        ...
        function Ba(a, b) {
            var d = b.find(".fp-slides"),
                c = d.find('.fp-slide[data-anchor="' + a + '"]');
        ...
        function Da(a) {
            ...
            else if (Q || R) history.replaceState(I, I, "#" + a);
            else {
        ...
        function x(a) {
            d.scrollBar ? f.scrollTop(a) : d.css3 ? pa("translate3d(0px, -" + a + "px, 0px)", !1) : f.css("top", -a)
        }
